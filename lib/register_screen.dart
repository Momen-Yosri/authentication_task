        ...
        child: Column(
         crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Text("Create an account",style: GoogleFonts.manrope(color: Color(0xff0000000),fontSize: 25,fontWeight: FontWeight.w600)),
            Text("Connect with your friends today!",style: GoogleFonts.manrope(color: Color(0xff999EA1),fontSize: 14,fontWeight: FontWeight.w600)),
            ...
            SizedBox(width: double.infinity,height: 45,
              child: ElevatedButton(onPressed: () {}, child: Text("Sign Up",style: GoogleFonts.manrope(fontSize: 17,fontWeight: FontWeight.w600)),style: ElevatedButton.styleFrom(
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Already have an account ?",style: GoogleFonts.manrope(fontSize: 14,fontWeight: FontWeight.w600,color: Color(0xff999EA1)),),
                TextButton(onPressed: () {
    Navigator.pushReplacementNamed(context, LoginScreen.routeName);
  }, child: Text("Login",style: GoogleFonts.manrope(fontSize: 14,fontWeight: FontWeight.w600,color: Color(0xff004182)),textAlign: TextAlign.center,))
              ],
            )
          ]),
      )
